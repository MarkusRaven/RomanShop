					...
					>
						<div class="appForm__step">
							...
							<div class="appForm__billingWrap">
								<div
									class="appForm__group appForm__group--full appForm__group--col "
								>
									...
									<Field
										...
										type="fio"
										class="appInput"
										v-model.trim="order.full_name"
										placeholder="ФИО"
									/>
									<ErrorMessage class="appError" name="fio" />
								</div>
								<div
									class="appForm__group appForm__group--half appForm__group--col "
								>
								...
								>
									...
									<Field
										...
										type="Address"
										class="appInput"
										v-model.trim="order.address.address"
						...
						<button class="appForm__btn appBtn appBtn--outline">
							Complete order
						</button>
					</Form>
				</div>
				<div class="payment__order order">
					<h2 class="appTitle appTitle--left order__title">
						Ваш заказ
					</h2>
					<p class="appText order__text">
						Цена может варьироваться в зависимости от способа
						доставки и налогов вашего города.
					</p>
					<div
						class="order__item itemSmall"
...
export default {
	...
	mounted() {
		this.product.price =
			this.cart.final_price > 0 ? this.cart.final_price : '200'
	},
	methods: {
		async completeOrder() {
